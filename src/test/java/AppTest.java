...
public class AppTest {
    ...
    public void testOneSuite() {
        ...
        String[] ss3 = {"G1", "G1", "G2", "G2", "G3", "G3", "G4", "G4", "G5", "G5", "G6", "G6", "G7", "B7"};
        ...
        p1.setTiles(Arrays.asList(ss2));
        p1.setTiles(Arrays.asList(ss3));
        p1.setTiles(Arrays.asList(ss4));
        p1.setTiles(Arrays.asList(ss5));
        p1.setTiles(Arrays.asList(ss6));
        ...
        System.out.println(p7.getTiles());
