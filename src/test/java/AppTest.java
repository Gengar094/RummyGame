...
public class AppTest {
    ...
    public void testSequence() {
        ...
        p2.reset();
        p3.reset();
        p1.setTiles(Arrays.asList("R1", "R1", "R2", "R3", "R3", "R4", "R4", "R5", "R5", "R6", "R12", "B12", "G12", "O12"));
        p3.setTiles(Arrays.asList("R2", "R13", "B2", "B2", "B3", "B3", "B4", "B4", "B5", "B5", "B6", "B13", "G2", "G13"));
        p2.setTiles(Arrays.asList("R11", "R12", "R13", "G1", "G2", "G3", "G4", "G5", "G6", "G7", "G8", "G9", "G10", "G11"));
        ...
        assertFalse(p2.getTiles().contains("G13"));
        assertFalse(p2.getTiles().contains("R2"));
        assertFalse(p2.getTiles().contains("B2"));
        assertFalse(p2.getTiles().contains("G2"));
