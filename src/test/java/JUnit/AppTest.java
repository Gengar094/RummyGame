...
public class AppTest {
    ...
    public void testInitialPoints6() {
        ...
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R4", "B4", "G4", "O4")));
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R5", "B5", "O5")));
        assertFalse(p1.getTiles().contains("R2"));
    ...
    public void testAfterInitial30_66() {
        ...
        assertEquals(gs.getGame().getTurn(), 2);
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R2", "G2", "O2")));
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R8", "B8", "G8", "O8")));
        assertFalse(p1.getTiles().contains("G2"));
        assertFalse(p1.getTiles().contains("R2"));
        assertFalse(p1.getTiles().contains("O2"));
        assertFalse(p1.getTiles().contains("O8"));
    ...
    public void testAfterInitial30_68() {
        ...
        assertEquals(gs.getGame().getTurn(), 2);
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R2", "G2", "O2")));
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R3", "G3", "O3")));
    ...
    public void test_87() {
        ...
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R11", "B11", "G11", "O11")));
        gs.play(new String[] {"R12", "B12", "G12"});
        gs.endTurn();
        assertFalse(p2.getTiles().contains("R12"));
        assertFalse(p2.getTiles().contains("B12"));
    ...
    public void test_101() {
        ...
        assertFalse(p2.getTiles().contains("G12"));
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("R12", "B12", "G12")));
        gs.play(new String[] {"O7", "O8", "O9", "O10"});
        gs.endTurn();
        assertFalse(p3.getTiles().contains("O7"));
        assertFalse(p3.getTiles().contains("O8"));
        assertFalse(p3.getTiles().contains("O9"));
        assertFalse(p3.getTiles().contains("O10"));
        assertTrue(gs.getGame().getTable().contains(Arrays.asList("O7", "O8", "O9", "O10")));
    ...
    public void test_simple_3() {
        ...
        assertFalse(p1.getTiles().contains("R4"));
        assertFalse(p1.getTiles().contains("R8"));
        assertTrue(gs.getGame().getTable().contains(new ArrayList<>(Arrays.asList("R4", "B4", "G4", "O4"))));
        assertTrue(gs.getGame().getTable().contains(new ArrayList<>(Arrays.asList("R4", "R5", "R6", "R7", "R8"))));
    }
    ...
    @DisplayName("Test for simple case 2")
    @Test
    public void test_simple_2() {
        p1.reset();
        p2.reset();
        p3.reset();
        p1.setTiles(new ArrayList<>(Arrays.asList("O11", "B11", "G11", "R1", "R2", "R3", "R4", "R5", "R6", "G10", "B10", "R13", "R7", "R8")));
        p2.setTiles(new ArrayList<>(Arrays.asList("O12", "B12", "G12", "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B9", "B10", "B11")));
        p3.setTiles(new ArrayList<>(Arrays.asList("R7", "R8", "R9", "R10", "R11", "R12", "G1", "G2", "G3", "G4", "G5", "G6", "G7", "G8")));
        gs.play(new String[] {"O11", "B11", "G11"});
        gs.endTurn();
        gs.play(new String[] {"O12", "B12", "G12"});
        gs.endTurn();
        gs.play(new String[] {"R7", "R8", "R9", "R10", "R11", "R12"});
        gs.endTurn();


        // 2 R13
        gs.addToCurrentMeld(3, new String[] {"R13"});
